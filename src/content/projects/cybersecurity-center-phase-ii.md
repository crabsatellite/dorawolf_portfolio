---
title: "National Cybersecurity Center, Phase II"
titleZh: "网安二期"
year: 2022
dateZh: "2021-08-19"
...
summaryZh: "一期已经在那里。二期的工作首先是接住，延续一期的格网与节奏，把新增体量降下来，让出一条贯穿南北的公共轴。"
align: "left"
noteZh: "一期已经在那里，二期的工作首先是*接住*。我们不试图与一期对话，而是把它当作既定的现实，延续它的格网、它的层高节奏、它的进退。新的二期为研发与孵化提供更多落地面积，同时为整个园区留出一条贯穿的*公共南北轴*。基础设施类项目的设计，常常是『不显眼地把对的事做对』。"
note: "Phase I was already there, and Phase II's first job was to *carry on*. Rather than enter a dialogue, we took Phase I as given: its grid, its rhythm of floors, its setbacks. The new phase opens more ground for research and incubation while leaving a continuous *public north-south axis* through the campus. Infrastructure work is often a matter of doing the right thing without being noticed."
---
## 接住一期

一期已经在那里，它的格网、层高节奏、屋顶曲面，都是既成的事实。我们没有把它当作一个需要回应或者超越的对象，只是把它读了一遍，然后顺着它往下接。展厅的曲面屋面在东侧抬起，二期向西延伸，沿同一条南北轴落下整片低层的研发与孵化体量。
...
考试中心、绿阶酒店、创客智谷、云环天街、活力社区，五处新落地的体量各自承担一类使用，但都被刻意降下了高度。我们不希望它们之中的任何一个抢过一期展厅。考试中心覆土处理，屋面作为可走的地景；绿阶酒店分高低区，低区贴近园区，服务师生与考试人群，高区藏在松林后面，留给商务接待。创客智谷是一组大棚架下的小聚落，内部可分可合，留出之后调整的余地。
