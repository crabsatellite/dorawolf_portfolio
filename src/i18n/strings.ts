...
const strings = {
  zh: {
    ...
    "archive.title": "档案",
    "archive.eyebrow": "研究 · 习作 · 项目",
    "archive.h1": "档案",
    "archive.lede":
      "工作室主线之外的研究档案：长期研究、参数化与模拟驱动的习作，以及历年项目的补充文本。文件按年份与类型自动从 GitHub 上的源仓库读取。",
    "archive.count": "共 {count} 件 · {years} 年跨度",
    "archive.filter_all": "全部",
    "archive.filter_year": "年份",
    "archive.filter_type": "类型",
    "archive.filter_tools": "工具",
    "archive.type.thesis": "研究",
    "archive.type.project": "项目",
    "archive.type.coursework": "习作",
    "archive.no_match": "没有作品匹配当前筛选。",
    "archive.read": "查看",
    "archive.source": "原始仓库",
    "archive.gallery": "图纸与图片",
    "archive.docs": "文档",
    "archive.models": "模型文件",
    "archive.downloads_zero_byte_note": "网页不持有任何二进制副本：所有图片与下载链接直指 raw.githubusercontent.com。",
    "archive.back": "← 返回档案列表",
    "lightbox.close": "关闭",
    "lightbox.prev": "上一张",
    "lightbox.next": "下一张",
  ...
  en: {
    ...
    "archive.eyebrow": "Research · Studies · Projects",
    "archive.h1": "Archive.",
    "archive.lede":
      "Studio research archive — extended investigations, parametric and simulation-driven studies, and supplementary documents from earlier projects. Files are read live from the source year-repos on GitHub.",
    "archive.count": "{count} works · spanning {years} years",
    "archive.filter_all": "All",
    "archive.filter_year": "Year",
    "archive.filter_type": "Type",
    "archive.filter_tools": "Tools",
    "archive.type.thesis": "Research",
    "archive.type.project": "Project",
    "archive.type.coursework": "Study",
    "archive.no_match": "No works match the current filter.",
    "archive.read": "Open",
    "archive.source": "Source repo",
    "archive.gallery": "Drawings & images",
    "archive.docs": "Documents",
    "archive.models": "Model files",
    "archive.downloads_zero_byte_note": "This site hosts zero binary bytes — every image and download link points directly at raw.githubusercontent.com.",
