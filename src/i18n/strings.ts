...
const strings = {
  ...
  en: {
    ...
    "case.attribution":
      "At China Architecture Design & Research Group · 2021 — 2023",
    ...
    "timeline.lede":
      "Two periods carry the current thread: the institute years at China Architecture Design & Research Group, Wuhan studio (2021 — 2023), and the independent practice that followed.",
