...
const strings = {
  zh: {
    ...
    "archive.h1": "档案",
    "archive.lede":
      "主线项目之外的内容收在这里。包括长期研究、参数化习作，和历年项目里没进作品集的文本。",
    "archive.count": "{count} 件 · {years}",
    ...
    "archive.docs": "文档",
    "archive.models": "模型文件",
    "archive.downloads_zero_byte_note": "网页本身不存文件，图片和下载链接都指向 GitHub 原始仓库。",
    "archive.back": "← 返回档案列表",
    "lightbox.close": "关闭",
    "lightbox.prev": "上一张",
    "lightbox.next": "下一张",
  ...
  en: {
    ...
    "archive.h1": "Archive.",
    "archive.lede":
      "Everything that sits outside the main projects lives here. Long-form research, parametric studies, and supplementary documents from earlier briefs.",
    "archive.count": "{count} works · {years}",
    ...
    "archive.downloads_zero_byte_note": "This site stores no files of its own. Every image and download points straight at the GitHub source repos.",
